...
def download(user_account, user_password):
    ...
    if user_account == "" or user_password == "":
        ...
        menu.click()
        input_menu = driver.find_element(By.XPATH,
                                         '//*[@id="nav-tabContent"]/div[1]/div[1]/div/div[1]/div[2]/div/div/div['
                                         '1]/input')
        ...
        if semester == "上學期":
            input_menu = driver.find_element(By.XPATH,
                                             '//*[@id="nav-tabContent"]/div[1]/div[1]/div/div[2]/div[2]/div/div/div[2]/ul/li[1]/a')
            input_menu.click()
        else:
            input_menu = driver.find_element(By.XPATH,
                                             '//*[@id="nav-tabContent"]/div[1]/div[1]/div/div[2]/div[2]/div/div/div[2]/ul/li[2]/a')
            input_menu.click()
        # 點擊「科目」的下拉式選單
        i = 0
        while True:
